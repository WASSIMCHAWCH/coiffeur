...
import { getWhatsAppLinkTo, getCancellationMessageToClient } from '../utils/whatsapp';
 ...
 *               client → message envoyé AU SALON pour signaler l'annulation
 */
export default function CancelConfirmModal({ appt, onClose, context = 'admin' }) {
  ...
  const waMessage = getCancellationMessageToClient({
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ fontWeight: 700, marginBottom: '6px', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.06em', color: '#16A34A' }}>
